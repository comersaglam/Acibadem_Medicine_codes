...
#H0= two variables are not related to each other alpha= 0,05
summary(regression)
...
func.regression =(
  if(result_regression(regression) <= 0.05){
...
language_a = as.factor(language_a)
levels(language_a)
